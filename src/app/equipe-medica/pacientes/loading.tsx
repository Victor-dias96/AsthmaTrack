...
/**
 * Route-level loading fallback for /equipe-medica/pacientes (Issue 107).
 * Renders inside the already-mounted MedicalTeamShell provided by the
 * parent layout (src/app/equipe-medica/layout.tsx) -- never re-renders the
 * shell, sidebar or mobile navigation itself, mirroring
 ...
 * values or record counts. Performs no Supabase query.
 */
